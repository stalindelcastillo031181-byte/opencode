...
export function PromptInputV2(props: PromptInputV2Props) {
  ...
  return (
    <div class={`relative size-full min-w-0 max-w-full flex flex-col gap-0 ${props.class ?? ""}`}>
      <input
      ...
      <form
        ...
        class="group/prompt-input relative min-h-[96px] w-full min-w-0 max-w-full box-border overflow-clip rounded-xl bg-v2-background-bg-base"
        classList={{
      ...
      >
        ...
        <div class="isolate flex h-11 min-w-0 items-center gap-1 px-2">
          <div
    ...
    >
      <MenuV2 gutter={6} modal={false} placement="top-start" onOpenChange={props.onOpenChange}>
        <MenuV2.Trigger
          ...
          variant="ghost-muted"
          size="normal"
          class={`min-w-0 max-w-[220px] justify-start overflow-hidden ![font-weight:440] ${props.class ?? ""}`}
          aria-label={props.title}
        >
          {props.currentIcon}
  ...
  return (
    ...
    >
      <IconButton
        ...
        variant="primary"
        class="relative z-10 size-7 shrink-0 rounded-md p-[6px] text-v2-icon-icon-muted shadow-[var(--v2-elevation-button-contrast)] disabled:opacity-50"
        style={{
          "background-image":
